...
export const AggregateReport: React.FC<AggregateReportProps> = ({ data, upaBials, month, year, onBack, onGoToDashboard }) => {
    ...
    const handleExport = () => {
        ...
        const fileName = `Tithe_Report_${month}_${year}.xlsx`;
    ...
    const handleExportPdf = () => {
        ...
        autoTable(doc, {
            body: [[`Aggregate Report for ${month} ${year}`]],
            theme: 'plain',
    ...
    return (
        <div className="printable-area">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                <div>
                    <h2 className="text-2xl font-bold text-slate-800">Aggregate Report</h2>
                    <p className="text-slate-600">Summary of contributions for {month} {year}</p>
                </div>
