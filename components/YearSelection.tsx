...
export const YearSelection: React.FC<YearSelectionProps> = ({ years, onSelectYear }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (selectedYear) {
      onSelectYear(parseInt(selectedYear, 10));
    }
  };

  return (
    <div className="text-center max-w-md mx-auto">
      <h2 className="text-2xl sm:text-3xl font-bold text-slate-800 mb-8">Select a Year to Begin</h2>
